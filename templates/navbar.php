<?php if (AutenticacaoController::estaLogado()): ?>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        <div class="container">
            <a class="navbar-brand" href="index.php?action=dashboard">💡 <?= htmlspecialchars(APP_NAME, ENT_QUOTES, 'UTF-8') ?></a>
...
<div class="container">
    <?php if (!empty($_SESSION['sucesso'])): ?>
        <div class="alert alert-success"><?= htmlspecialchars($_SESSION['sucesso'], ENT_QUOTES, 'UTF-8') ?></div>
        <?php unset($_SESSION['sucesso']); ?>
    <?php endif; ?>

    <?php if (!empty($_SESSION['erro'])): ?>
        <div class="alert alert-danger"><?= htmlspecialchars($_SESSION['erro'], ENT_QUOTES, 'UTF-8') ?></div>
